  ...
  return <section className="section-padding bg-secondary">
      <div className="container-landing">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          {credentials.map((item, index) => <div key={index} className="bg-card rounded-xl p-6 shadow-card card-hover text-center">
        ...
        <div className="bg-gradient-to-r from-embrapa to-primary rounded-2xl p-8 md:p-12 text-white">
          <div className="flex flex-col md:flex-row items-center gap-8">
            <img alt="Tecnologia EMBRAPA" className="w-32 h-32 object-contain" src="/lovable-uploads/5a8da977-d484-4b34-bf5c-dab940a8a104.png" />
            <div className="flex-1 text-center md:text-left">
              ...
              <ul className="space-y-2">
                {["Resultado de mais de 15 anos de pesquisa", "Testado em diversas regiões produtoras do país", "Única solução eficaz contra M. enterolobii"].map((item, i) => <li key={i} className="flex items-center gap-2">
