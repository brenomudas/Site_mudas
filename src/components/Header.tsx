        ...
        <div className="container-landing">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden lg:flex items-center gap-6">
              {navLinks.map((link) => (
                <a
                  key={link.href}
                  href={link.href}
                  className={`text-sm font-medium transition-colors hover:text-emerald-600 ${isScrolled ? "text-foreground" : "text-white hover:text-white/80"
                    }`}
                >
                  {link.label}
                </a>
            ...
            <button
              ...
              className={`lg:hidden flex items-center justify-center p-2.5 rounded-xl transition-all duration-200 ${isScrolled
