...
import { PhoneDisplay } from "./WhatsAppButton";
import { Youtube, Instagram } from "lucide-react";

const Footer = () => {
  const currentYear = new Date().getFullYear();
  return <footer className="bg-foreground text-white/70 py-12">
      <div className="container-landing">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          {/* Logo */}
          <div className="flex items-center gap-4">
            <img alt="São Francisco Mudas" className="h-12 w-auto bg-white rounded-lg p-2" src="/lovable-uploads/5517861d-1eea-4aeb-8be8-990ba3a36f87.png" />
            <div>
