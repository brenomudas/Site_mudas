import mudasCaixas from "@/assets/mudas-caixas-transporte.jpg";
...
const LogisticsSection = () => {
  ...
  return <section className="section-padding" id="logistica">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {steps.map((step, index) => <div key={index} className="flex items-start gap-3 p-4 bg-secondary rounded-xl">
            ...
            <div className="bg-leaf-light rounded-xl p-6">
              ...
              <div className="flex flex-wrap gap-2">
                {regions.map((region, index) => <span key={index} className="inline-flex items-center gap-1 px-3 py-1 bg-primary/10 text-primary rounded-full text-sm">
          ...
          <div className="relative">
            ...
            <img alt="Mudas organizadas em caixas para transporte" className="relative w-full rounded-2xl shadow-elevated" src="/lovable-uploads/32956fc3-a7ae-4667-9d59-827a5ea5ab60.jpg" />
          </div>
        </div>
      </div>
    </section>;
